...
export default function ResearchPage() {
  ...
  async function commitEdit(feature) {
    ...
    const payload = {
      ...
      validFrom: editValues.validFrom || null,
      validTo: editValues.validTo || null,
      metadata,
      geometry:
                            ...
                            <div className="db-edit-grid">
                              ...
                              <div className="db-field">
                                ...
                                <input
                                  ...
                                  onChange={(e) =>
                                    setEditValues((v) => ({ ...v, validFrom: e.target.value }))
                                  }
                                  className="db-input"
                                />
                              </div>
                              <div className="db-field">
                                ...
                                <input
                                  ...
                                  onChange={(e) =>
                                    setEditValues((v) => ({ ...v, validTo: e.target.value }))
                                  }
                                  className="db-input"
                                />
                              </div>
                  ...
                  return (
                    <tr key={feature.id} className={`db-row${isEdited ? " db-row--edited" : ""}`}>
                      ...
                      <td className="db-cell--date">
                        {feature.properties.validFrom || feature.properties.validTo
                          ? `${feature.properties.validFrom ?? "..."} - ${feature.properties.validTo ?? "..."}`
                          : "-"}
                      </td>
                      <td>
